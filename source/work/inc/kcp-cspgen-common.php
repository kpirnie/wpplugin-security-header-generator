        ...
        public static function get_csp_directives(): array
        {
            ...
            return array(
                ...
                'style-src-elem' => array(
                    ...
                    'desc' => __('Specifies valid sources for stylesheets &lt;style&gt; elements and &lt;link&gt; elements with rel="stylesheet".', 'security-header-generator'), // phpcs: WordPress.WP.EnqueuedResources.NonEnqueuedStylesheet 
                ),
