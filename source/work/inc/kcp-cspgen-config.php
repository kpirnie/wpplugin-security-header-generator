...
if (! class_exists('KCP_CSPGEN_Configs')) {
    ...
    class KCP_CSPGEN_Configs
    {
         ...
         * @return array
         */
        public static function get_csp_wp_defaults(): array
        {

            // hold the defaults array
            $defaults = array(
                'generate_csp_custom_styles' => ' https: *.googleapis.com ',
                'generate_csp_custom_styles_elem' => ' https: *.googleapis.com ',
                ...
                'generate_csp_custom_fonts' => ' https: *.gstatic.com ',
                'generate_csp_custom_images' => ' https: *.gravatar.com *.wordpress.org s.w.org ',
                'generate_csp_custom_connect' => ' https: ',
                'generate_csp_custom_frames' => ' https: *.youtube.com *.vimeo.com ',
            ...
            return apply_filters('wpsh_csp_wp_defaults', $defaults);
        }
